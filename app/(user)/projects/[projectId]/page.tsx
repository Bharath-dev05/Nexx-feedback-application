...
const project =projects[0];
    ...
    return(
        <div >
            <div>
                <Link href={"/dash-board"} className="flex items-center text-indigo-700 mb-5">
                <ChevronLeft className=' h-5 mr-1 w-fit'/><span> Back to projects</span>
                </Link>
            </div>
       ...
       <Link href={project.url} className="underline text-indigo-700 flex items-center">
        ...
        className="underline text-indigo-700 flex items-center mt-2">
            <Code  className="h-5 w-5 mr-1"/><span className="text-lg">Embed code</span>
        </Link>
       </div>
        </div>
        <div>
