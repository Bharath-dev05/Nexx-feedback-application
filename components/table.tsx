            ...
            <tr key={headerGroup.id} className="border-b border-slate-300">
              {headerGroup.headers.map((header) => {
                return (
                  <th
                    key={header.id}
                    className="text-left bg-gray-50 rounded-t-md pb-2 p-4"
...
function Filter({
  ...
  column: Column<Feedback, string | number |unknown|null>;
  ...
  return typeof firstValue === "number" ? (
    ...
    <input
      className="w-36 border shadow rounded p-2 text-slate-800 font-thin"
